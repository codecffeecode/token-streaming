      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Connected wallet: <span className="font-mono text-primary-500">{formatAddress(address)}</span>
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Salary Streaming</h2>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">Start streaming your salary payments on the blockchain</p>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">Your streaming activity will appear here</p>
            </div>
          </div>
        </div>
      </div>
